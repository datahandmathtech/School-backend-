...
const Story = ({ onBack }) => {
  return (
    <div className="page-container" style={{ padding: '8rem 10% 4rem 10%', minHeight: '100vh', background: '#1b140f', color: 'var(--text-main)' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
        ...
        >
          <h2 className="subtitle" style={{ color: 'var(--primary)', fontSize: '0.9rem', letterSpacing: '0.2rem', textTransform: 'uppercase' }}>The Slow-Food Sourdough Philosophy</h2>
          <h1 className="hero-title" style={{ fontSize: '3.6rem', color: 'var(--light)', margin: '1rem 0' }}>Crafted Bread <br /> Earthy Roots</h1>
          <p className="description" style={{ fontSize: '1.02rem', color: 'var(--text-muted)', lineHeight: '1.8', marginBottom: '2rem' }}>
            Every single loaf of sourdough we serve is baked fresh right here in our open-air valley kitchen. We use stone-ground ancient grains, wild yeast cultures, and a **36-hour slow cold fermentation process**. 
            <br /><br />
            This results in an incredibly light, naturally digestible crumb that is bursting with complex, earthy lactic acid flavors. We partner directly with organic farmers across Rajasthan to ensure every root, seed, and herb is grown with ultimate respect for the earth and soil.
          </p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1.5rem' }}>
          {[
            ...
            <div key={i} style={{ background: 'rgba(255,255,255,0.02)', padding: '1.2rem', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.04)' }}>
              <h4 style={{ color: 'var(--light)', margin: 0, fontSize: '1rem' }}>{item.name}</h4>
