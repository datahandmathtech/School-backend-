...
const Contact = ({ onBack }) => {
  return (
    <div className="page-container" style={{ padding: '8rem 10% 4rem 10%', minHeight: '100vh', background: '#120e0a', color: 'var(--text-main)' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'start' }}>
        ...
        >
          ...
          <h1 className="hero-title" style={{ fontSize: '3.2rem', color: 'var(--light)', margin: '1rem 0' }}>The Hillside Garden Deck</h1>
          ...
          <div style={{ marginTop: '2rem', borderTop: '1px solid rgba(255,255,255,0.06)', paddingTop: '1.5rem' }}>
            <motion.a
              ...
              style={{ color: 'var(--light)', display: 'flex', alignItems: 'center', gap: '0.5rem', textDecoration: 'none', fontSize: '0.9rem' }}
            >
        ...
        >
          <form onSubmit={(e) => { e.preventDefault(); alert('Reservation Request Received! We will text you shortly to confirm.'); }} style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
            <div>
              ...
              <h1 className="hero-title" style={{ fontSize: '3.2rem', color: 'var(--light)', margin: '1rem 0' }}>Book Your Experience</h1>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <div className="form-group" style={{ gap: '0.4rem' }}>
                ...
                <input type="text" placeholder="Abhay Patel" required className="form-input" style={{ padding: '0.8rem 1.2rem', borderRadius: '12px', fontSize: '0.9rem' }} />
              </div>
