  ...
  return (
    <main className="relative min-h-screen bg-slate-50 selection:bg-primary selection:text-white pt-24 md:pb-0 pb-16">
      ...
      <div className="bg-slate-900 py-32 px-6 text-center relative overflow-hidden">
        ...
        <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter mb-8 leading-[0.95]">Contact <br className="md:hidden" /><span className="text-primary">GoGetGo</span> Destination</h1>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-6 p-8 bg-white rounded-[2rem] border border-slate-100 shadow-xl shadow-slate-200/50 group hover:border-primary/30 transition-all duration-500">
                ...
                <div>
                  ...
                  <a href="tel:+9180000505810" className="font-black text-slate-900 text-xl hover:text-primary transition-colors tracking-tighter">Call Now</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6 p-8 bg-white rounded-[2rem] border border-slate-100 shadow-xl shadow-slate-200/50 group hover:border-primary/30 transition-all duration-500">
                ...
                <div>
                  ...
                  <a href="mailto:info@gogetgodestination.com" className="font-black text-slate-900 hover:text-primary transition-colors tracking-tight text-lg">info@gogetgodestination.com</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="fixed bottom-0 left-0 w-full z-[100] md:hidden flex border-t border-slate-200 bg-white">
        <a href="tel:+9180000505810" className="flex-1 bg-slate-900 text-white flex items-center justify-center gap-2 py-4 font-bold text-sm uppercase"><Phone className="w-4 h-4 text-primary" /> Call Now</a>
        <a href="https://wa.me/9180000505810" className="flex-1 bg-[#25D366] text-white flex items-center justify-center gap-2 py-4 font-bold text-sm uppercase"><MessageCircle className="w-4 h-4" /> WhatsApp</a>
      </div>
    </main>
  );
}
