  ...
  return (
    <main className="relative min-h-screen bg-[#FDFBF7] selection:bg-gold-premium selection:text-midnight pt-20 md:pb-0 pb-16 font-sans">
      ...
      <div className="fixed bottom-0 left-0 w-full z-[100] md:hidden flex border-t border-slate-200 bg-white">
        ...
        <a href="https://wa.me/9180000505810" className="flex-1 bg-[#25D366] text-white flex items-center justify-center gap-2 py-4.5 font-bold text-xs uppercase tracking-wider"><MessageCircle className="w-4 h-4 fill-current" /> WhatsApp</a>
      </div>
    </main>
  );
}
