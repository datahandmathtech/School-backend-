        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-2 md:gap-3 group">
            ...
            <div className={`flex flex-col transition-colors duration-300 ${isSolid ? "text-midnight" : "text-white"}`}>
              <span className="text-lg md:text-3xl font-black tracking-tighter leading-none">GOGETGO</span>
          ...
          <div className="relative flex flex-col p-8 min-h-screen z-10">
              ...
              <div className="flex justify-between items-center mb-12 pt-2">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    <span className="text-white font-black text-2xl leading-none tracking-tighter">GOGETGO</span>
              ...
              <div className="mt-auto pt-12 pb-8 space-y-8">
                <div className="space-y-4">
                    ...
                    <a href="tel:+9180000505810" className="flex items-center gap-4 text-white group">
