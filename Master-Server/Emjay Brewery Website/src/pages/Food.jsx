...
const Food = ({ onBack }) => {
  return (
    <div className="page-container" style={{ padding: '8rem 10% 4rem 10%', minHeight: '100vh', background: '#1c1510', color: 'var(--text-main)' }}>
            ...
            {[
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                  ...
                  <span style={{ fontSize: '1.15rem', color: 'var(--light)', fontWeight: 600, paddingLeft: '1rem' }}>{item.price}</span>
                </div>
