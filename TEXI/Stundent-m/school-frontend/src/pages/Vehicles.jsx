...
const Vehicles = () => {
    ...
    const handleCreateVehicle = async (e) => {
        ...
        try {
            ...
            setSeatingCapacity('4'); setBusType(''); setRemarks('');
                    ...
                    >
                        ...
                        <form onSubmit={handleCreateVehicle} style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                                ...
                                {carType === 'Bus' || carType === 'Mini Bus' ? (
                                    <div className="form-grid-2">
                                        <div className="form-group">
                                            <label>Bus Type (Capacity)</label>
                                            <div style={{ position: 'relative' }}>
                                                <div style={{ position: 'absolute', left: '16px', top: '50%', transform: 'translateY(-50%)', color: 'var(--primary)' }}>
                                                    <Car size={16} />
                                                </div>
                                                <select
                                                    ...
                                                    onChange={(e) => {
                                                        ...
                                                        setSeatingCapacity(e.target.value.split('-')[0]); // Auto set capacity
                                                    }}
                                                >
                                                    <option value="" style={{ background: '#0f172a' }}>Select Bus Type</option>
                                                    <option value="15-seater" style={{ background: '#0f172a' }}>15 Seater (Mini)</option>
                                                    <option value="35-seater" style={{ background: '#0f172a' }}>35 Seater</option>
                                                    <option value="46-seater" style={{ background: '#0f172a' }}>46 Seater (Large)</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
