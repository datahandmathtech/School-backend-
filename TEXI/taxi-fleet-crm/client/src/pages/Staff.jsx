                                                            ...
                                                            <div style={{ display: 'flex', gap: '12px' }}>
                                                                ...
                                                                {item.staffType !== 'Fixed' && item.staffType !== 'Daily' && (
                                                                    <>
                                                                        ...
                                                                        <div>
                                                                            <div style={{ fontSize: '13px', fontWeight: '900', color: '#6366f1' }}>{item.previousMonthCarryForward || 0} <span style={{ opacity: 0.3, fontSize: '10px' }}>C/F</span></div>
                                                                            <div style={{ fontSize: '9px', fontWeight: '800', color: '#6366f1', textTransform: 'uppercase' }}>Prev C/F</div>
                                                                        </div>
                                                                        <div style={{ width: '1px', height: '24px', background: 'rgba(255,255,255,0.1)' }}></div>
                                                                        <div>
                                                                            <div style={{ fontSize: '13px', fontWeight: '900', color: 'var(--primary)' }}>{item.totalLeaveAvailable || 0} <span style={{ opacity: 0.3, fontSize: '10px' }}>AVAIL</span></div>
                                                                            <div style={{ fontSize: '9px', fontWeight: '800', color: 'var(--primary)', textTransform: 'uppercase' }}>Available</div>
                                                                        </div>
                                                                        <div style={{ width: '1px', height: '24px', background: 'rgba(255,255,255,0.1)' }}></div>
                                                                        <div>
                                                                            <div style={{ fontSize: '13px', fontWeight: '900', color: '#fbbf24' }}>{item.leavesTakenThisMonth || 0} <span style={{ opacity: 0.3, fontSize: '10px' }}>USED</span></div>
                                                                            <div style={{ fontSize: '9px', fontWeight: '800', color: '#fbbf24', textTransform: 'uppercase' }}>Utilized</div>
                                                                        </div>
                                                                    </>
                                                                )}
                                                            </div>
