...
import { Plus, Edit, Trash2, Battery, Car, ShieldAlert, ShieldCheck, FileText, CheckCircle2, Activity, Info, Loader2 } from 'lucide-react';
...
const AutoManagement = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setShowModal(false);
            setEditingId(null);
            setFormData({ autoNumber: '', model: '', rcNumber: '', rcExpiry: '', insuranceExpiry: '', rcPhoto: '', insurancePhoto: '', lastKM: '' });
    ...
    return (
        <div style={{ backgroundColor: '#0d111c', minHeight: '100vh', padding: '1rem', borderRadius: '16px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
                <div>
                    <h1 style={{ fontSize: '1.5rem', color: '#fff', margin: 0 }}>Fleet Management</h1>
                    <p style={{ color: '#8a94a6', fontSize: '0.8rem', marginTop: '0.2rem' }}>Register, edit, and track your autos.</p>
                </div>
                <button className="btn btn-primary" onClick={() => { setEditingId(null); setFormData({ autoNumber: '', model: '', rcNumber: '', rcExpiry: '', insuranceExpiry: '', rcPhoto: '', insurancePhoto: '', lastKM: '' }); setPreviews({ rcPhoto: null, insurancePhoto: null }); setShowModal(true); }} style={{ padding: '0.6rem 1.2rem', borderRadius: '8px' }}>
                ...
                <div style={{ backgroundColor: '#131824', borderRadius: '12px', overflow: 'hidden' }}>
                    <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                        ...
                        <tbody>
                            ...
                            {autos.length === 0 && (
                                <tr><td colSpan="6" style={{ padding: '2rem', textAlign: 'center', color: '#6e7a93' }}>No vehicles registered yet.</td></tr>
                            )}
                        </tbody>
                    </table>
                </div>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', marginTop: '0.5rem' }}>
                    ...
                    <div style={{ background: 'rgba(255,255,255,0.02)', padding: '1.25rem', borderRadius: '12px', border: '1px solid var(--border-glass)' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                            ...
                            <div>
                                <label style={{ display: 'block', marginBottom: '0.4rem', color: '#8a94a6', fontSize: '0.8rem', fontWeight: 600 }}>Opening KM</label>
